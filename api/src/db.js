...
const sequelize = new Sequelize(`postgres://${DB_USER}:${DB_PASSWORD}@${DB_HOST}/recipeBudgets`, {
...
const { User, Recipe, Ingredient } = sequelize.models;

// Aca vendrian las relaciones

User.hasMany(Recipe, { through: 'UserRecipe' }); // Un usuario puede tener muchas recetas
Recipe.belongsTo(User, { through: 'UserRecipe' }); // Una receta pertenece a un usuario
